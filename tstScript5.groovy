...
WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/div_sadfasdfasdf_fa fa-trash-o pr-3'))

WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/button_Xc nhn'))

WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/div_dfasdfasdfas_fa fa-trash-o pr-3'))
