...
WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/a_Lp 3'))

WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/a_Bi tp cui tun Ton 3 Tp 2'))
...
WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/span_alo'))
